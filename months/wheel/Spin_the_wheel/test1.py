...
from PyQt5.QtWidgets import (
    ...
    QLineEdit, QDialog, QListWidget, QHBoxLayout, QMessageBox, QWidget, QInputDialog
)
...
class CoupleWishGameUI(QMainWindow):
    ...
    def spin_wheel(self, wheel_type):
        ...
        if wheel_type == "general":
            ...
            # Ask for specialized wheel spinner again
            cost = 25
        ...
        # Check if the selected wheel has any items
        if not wheel:
            QMessageBox.warning(self, "Error", f"The {wheel_type.capitalize()} Wheel is empty!")
            return
